...
public class GlowingPlayersGui {
    ...
    public static void buildGlowingPlayersGui(ConfigBuilder builder) {
        ...
        category.addEntry(new CustomEntry()
                ...
                .addButton(Component.literal("+"), 20, CustomEntry.Alignment.RIGHT, () -> GlowingPlayerCreationScreen.openScreen(Minecraft.getInstance().screen), Component.literal("Add Glowing Player"))
