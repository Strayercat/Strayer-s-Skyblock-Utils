                ...
                .then(ClientCommands.literal("dev")
                        ...
                        .then(ClientCommands.literal("coordinates")
                                .then(ClientCommands.literal("add").executes(context -> {
                                    ...
                                    Minecraft.getInstance().gui.getChat().addClientSystemMessage(Component.literal("Coordinates added"));
                                    return 1;
                                }))
                                ...
                                .then(ClientCommands.literal("clear").executes(context -> {
                                    ...
                                    Minecraft.getInstance().gui.getChat().addClientSystemMessage(Component.literal("Coordinates cleared"));
                                    return 1;
                                }))
                        )
